...
function Wind() {
    ...
    return (
        <div className='pt-6 px-4 h-[12rem] border rounded-lg flex flex-col gap-3 dark:bg-[#0A0A0A] shadow-sm dark:shadow-none'>
            <h2 className='flex items-center gap-2 font-medium'><WindIcon size={16} />Wind</h2>
